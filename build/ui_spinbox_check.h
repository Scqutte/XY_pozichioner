...
#ifndef UI_SPINBOX_CHECK_H
#define UI_SPINBOX_CHECK_H
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        spinMoveStep->setMinimumSize(QSize(150, 42));
        ...
        contentLayout->addWidget(panelGcode, 2, 0, 1, 1);
        ...
        contentLayout->addWidget(panelChannels, 1, 1, 2, 1);
